function setup() {
    ...
    $( "#txtName" ).focus(function() {
        $( "#tipText" ).text("You should be a Citizen of India to file RTI Application. Organisations, Private / Public Companies can't file RTI. <br/>Unfortunately, this application is applicable only to the states of <br/>Tamil Nadu, Kerala, West Bengal, Chandigarh, Delhi, Himachal Pradesh, Karnataka, Uttarakhand, Tripura, Mizoram, Puducherry, Meghalaya, Noida, Andaman and Nicobar, Goa, Jharkhand, Manipur, Nagaland");
    ...
    $( "#radioFeeCourtFee" ).focus(function() {
        $( "#tipText" ).text("Court Fee Stamps can be bought in Courts, Stamp shops near Taluk offices, etc., Court fee stamp is applicable in following States: Tamil Nadu, Kerala, West Bengal");
        $( "#tipContainer" ).offset({top: $(this).offset().top - 100});
    });

    $( "#radioFeePostalOrder" ).focus(function() {
        $( "#tipText" ).text("A Postal order of Rs. 10.00 can be taken from Post Office and attached with the RTI Application. Post Order is applicable in following States: Assam, Chandigarh, Delhi, Himachal Pradesh, Karnataka, Uttarakhand, Tripura, Mizoram, Puducherry, Meghalaya, Noida.");
        $( "#tipContainer" ).offset({top: $(this).offset().top - 100});
    });

    $( "#radioFeeDD" ).focus(function() {
        $( "#tipText" ).text("Demand Draft can be drawn in favor of PIO and be attached with the RTI Application. Demand Draft is applicable in following States: Andaman and Nicobar, Goa, Jharkhand, Manipur, Nagaland");
        $( "#tipContainer" ).offset({top: $(this).offset().top - 100});
    });
...
function generate() {
    ...
    otherWindow.document.write($("Public Information Officer").val() + "<br/>");
...
var listQuestions = [
    [ //EPF Withdrawl
        "1. Mention the date of receipt of my application and its current status.",
        ...
        "4. Name, designation, phone number and email address of the officer to dispose my application.",
        "5. Please also mention the office timings of above mentioned officer", "6. Time frame for disposal of my application under the Rules / Regulation / Notification / Order / Circular / Memo / Norms / Guidelines / Direction",
        "7. Name and Designation of the officer to complain, if my application is not disposed properly within the time frame",
        "8. Certified copies of all correspondences sent / received for disposal of my application",
        "9. Please provide me the details of First Appellate Authority u/s 7(8) of RTI Act, 2005 with detailed postal and email address."
    ],
    [ // Pending work in any govt department
        ...
        "4. Please give the proof of receipt and dispatch of my complaint in the office of each of these officials.",
        "5. According to your Rules / Regulation / Notification / Order / Circular / Memo / Norms / Guidelines / Direction / citizens charter, in how many days should such a matter be dealt with and resolved. Please provide me the certified copy of the relevant document",
        "6. Provide me the certified copy of conduct service rule / regulation having provision to take disciplinary action for non adherence to the timeframe",
        "7. By when will my problem be resolved?",
        "8. Provide the certified copy of file Noting related to the complaint",
        "9. Provide the certified copy of Work Order pertaining to my complaint, if any",
    ...
    [ // Street and road works carried out
        "1. Please give a list of all the works / projects related to improvement of roads or streets carried out in my area (____________________________) for past ________ (months / years). The list should contain the name of the work, Work Order No, actual date of start, actual date of completion, amount paid or payable, status of work, list of street / roads covered",
        ...
        "5. Provide me the certified copy of Contract document with contractor",
    ...
    [ // School scholarship
        ...
        "3. Time frame to provide the scholarship amount from the receipt of my Scholarship application",
        "4. Number of students who received the scholarship in the year ______________ . Provide an certified copies of the receipt register which contains the signatures of the students and their parents.",
        "5. Are there any rules and regulations for distribution of scholarships among students? Provide an attested copy of all related Rules / Regulation / Notification / Order / Circular / Memo / Norms / Guidelines / Direction.",
        ...
        "7. If a student has not received the scholarship yet, then specify the reason. Provide a list of all such students who have not been given the scholarship yet with the following particulars: 1. Name of the student 2. Father’s name 3. Reason for rejection of scholarship",
    ...
    [ // Ration Card
        ...
        "4. Last 3 inspection reports by Metrology department on the status of tools ",
...
var listSubjects = [
    "Status of withdrawl of my Employees’ Provident Fund (EPF) Account",
    ...
    "Status of all corruption complaints from CVC",
...
var listDetails = [
    "I have an Employees’ Provident Fund (EPF) account with my previous employer ____________ (establishment name) establishment based in _____________ (City). I applied for withdrawal of my EPF account on _________ (dd/mm/yy), but I have been waiting for ____ (years) now. I would like to know the following.",
    "I made a complaint dated __________ (dd/mm/yy) for the following reason ______________. (Copy of application is attached). But no satisfactory action has been taken on my application so far. The RPAD receipt number is ___________________ (RTXXXXXXXXXXIN)",
    "Enquiry on MLA Development Funds",
